...
class ConstructionTableGroup(db.Model):
    ...
    tables = relationship("ConstructionTable", back_populates="group", cascade="all, delete-orphan", order_by="ConstructionTable.uid")
    # region CRUD
    ...
    def __repr__(self):
        return f'<construction_table_group {self.uid}>'