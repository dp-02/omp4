...
class ConstructionTableOption(Base):
    ...
    tables = relationship("ConstructionTable", back_populates="options")
    datas = relationship("ConstructionTableData", back_populates="option", cascade="all, delete-orphan", order_by="ConstructionTableData.uid")
    # region CRUD
