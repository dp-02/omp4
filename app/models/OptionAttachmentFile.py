...
class OptionAttachmentFile(db.Model):
    ''' 選項資料附件檔案 '''
    __tablename__ = 'option_attachment_file'
    ...
    attachment = relationship("OptionAttachment", back_populates="files")
    ...
    def __repr__(self):
        return f'<option_attachment_file {self.uid}>'
